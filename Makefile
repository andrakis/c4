...
test-c4rstrip: c4rstrip c4rstrip.c4r $(C4M) $(C4RDUMP) $(C4RLINK) hello.c4r factorial.c4r
	./c4rstrip -o .strip_hello.c4r hello.c4r > /dev/null
	[ $$(stat -c %s .strip_hello.c4r) -lt $$(stat -c %s hello.c4r) ]
	$(C4M) load-c4r.c -- hello.c4r 2>&1 | grep -v -e '^lc4r:' -e '^Trap type' > .strip_a.txt; $(C4M) load-c4r.c -- .strip_hello.c4r 2>&1 | grep -v -e '^lc4r:' -e '^Trap type' > .strip_b.txt
	...
	$(C4RLINK) -s factorial.c4r -o .strip_link.c4r > /dev/null
	$(C4RDUMP) .strip_link.c4r | grep -q "Symbols = 0 (stripped)"
	$(C4M) load-c4r.c -- factorial.c4r 2>&1 | grep -v -e '^lc4r:' -e '^Trap type' > .strip_c.txt; $(C4M) load-c4r.c -- .strip_link.c4r 2>&1 | grep -v -e '^lc4r:' -e '^Trap type' > .strip_d.txt
