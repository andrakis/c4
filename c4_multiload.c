// c4_multiload.c - C in four functions, supporting multiple files
//
// Usage:
//  c4 c4_multiload.c <first file.c> [file n.c, ...] [-- arguments...]
// Example:
//  c4 c4_multiload.c classes.c classes2.c -- test arguments
