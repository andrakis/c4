 ...
 *__c4_invoke_stub_addr++ = JMP;
 ...
 int __c4_invoke_setup_complete;
...
enum {
 ...
 C4R_HDR_PATCHLEN,
 C4R_HDR_SYMBOLSLEN,
 C4R_HDR_CONSTRUCTLEN,
 C4R_HDR_DESTRUCTLEN,
 C4R_HDR__Sz
};
# 51 "include/c4r.h"
int C4R_PTYPE_CODE, C4R_PTYPE_DATA;
# 60 "include/c4r.h"
enum {
 C4R_PAT_TYPE,
 C4R_PAT_ADDRESS,
...
void _c4r_stacktrace_perform_setup () {
 ...
 void _c4r_stacktrace_constructor (int *c4r, int *syscall) {
 _c4r_stacktrace_perform_setup();
}

void c4r_print_stacktrace (int *c4r, int *alt, int *pc) {
 int *bp, *returnpc, *entrypc, depth;
