...
(define sc:next (lambda (X Dst)
	(begin
		...
		(if (= F sc:curname)
			(begin
				(define Mark sc:temp)
				(define As (sc:args (tail (tail X)) (list)))
...
(set! Text (+ Text (+ NL NL)))
(set! Text (+ Text (+ "#include " (+ DQ (+ "c4.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "c4m.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "c4_float.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sp/include/cell.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sp/include/gc.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sp/include/cells.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sp/include/atoms.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sp/include/read.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sp/include/stdlib.h" (+ DQ NL))))))
(set! Text (+ Text (+ "#include " (+ DQ (+ "src/c4sc/scrt.h" (+ DQ (+ NL NL)))))))
